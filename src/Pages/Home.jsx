...
const SOCIAL_LINKS = [
  ...
  {
    icon: Linkedin,
    link: "https://www.linkedin.com/in/peyyala-lohit-a2ba16265/",
  },
  {
    icon: Instagram,
    link: "https://www.instagram.com/lohithchocolate?igsh=MWsyMmJob2Vwb2Zl",
  },
];
...
const Home = () => {
  ...
  // Lottie configuration    https://lottie.host/58753882-bb6a-49f5-a2c0-950eda1e135a/NLbpVqGegK.lottie
  const lottieOptions = {
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                >
                  ...
                  {/* <img
        src={lottieOptions.src} // Set the image source dynamically
        alt="Profile"
        style={lottieOptions.style} // Apply styles dynamically
        className={lottieOptions.className} // Apply hover effects dynamically
        loading="lazy"
      /> */}
                </div>
