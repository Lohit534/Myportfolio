...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/peyyala-lohit-a2ba16265/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Lohit_chocs",
    icon: Instagram,
    url: "https://www.instagram.com/lohithchocolate?igsh=MWsyMmJob2Vwb2Zl",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Lohit534",
    icon: Github,
    url: "https://github.com/Lohit534", // Add your GitHub URL here
    color: "#ffffff",
