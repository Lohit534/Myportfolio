...
const CardInternship = ({ Img, Title, Description, Link: InternshipLink, id }) => {
  const handleLiveDemo = (e) => {
    if (!InternshipLink) {
      console.log("InternshipLink is empty");
      e.preventDefault();
      alert("Internship details are not available online.");
    }
  };
  ...
  const handleDetails = (e) => {
    if (!id) {
      ...
      e.preventDefault();
      alert("Internship details are not available.");
    }
  };

  return (
    <div className="group relative w-full">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900/90 to-gray-800/90 border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-blue-500/20">
          ...
          <div className="mt-4 space-y-3">
            ...
            <div className="pt-4 flex items-center justify-between">
              {InternshipLink ? (
                ...
                <span className="text-gray-500 text-sm">Website Not Available</span>
              )}
